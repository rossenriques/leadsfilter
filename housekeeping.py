...
# Directory path
directory = r"C:\Users\Dell\Documents\Leads\Housekeeping"
...
for item in newList:
    ...
    businessType = item[5]
    excluded_types = ["wholesale", "inn", "store", "health", "non-profit", "pet", "laundromat", "hotel", "doula", "organization", "aged", "retirement", "assisted", "government", "consultant", "complex", "daycare", "hairdresser"]
    excluded_names = ["walmart", "target", "inn", "motel", "goodwill", "retirement"]
    included_types = []
